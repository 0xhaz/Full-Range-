...
import {FullRangeImplementation} from "test/shared/FullRangeImplementation.sol";
...
import {HookEnabledSwapRouter} from "test/utils/HookEnabledSwapRouter.sol";
...
contract TestFullRange is Test, Deployers, GasSnapshot {
    ...
    uint16 constant LOCKED_LIQUIDITY = 1_000;
    ...
    function test_FullRange_beforeInitialize_AllowsPoolCreation() public {
    ...
    function test_FullRange_beforeInitialize_RevertsIfWrongSpacing() public {
    ...
    function test_FullRange_addLiquidity_InitialAddSucceeds() public {
    ...
    function test_FullRange_addLiquidity_InitialAddFuzz(uint256 amount) public {
        manager.initialize(key, SQRT_PRICE_1_1, ZERO_BYTES);
        if (amount <= LOCKED_LIQUIDITY) {
            ...
            (bool hasAccruedFee, address liquidityToken) = fullRange.poolInfo(id);
            uint256 liquidityTokenBal = UniswapV4ERC20(liquidityToken).balanceOf(address(this));

            assertEq(manager.getLiquidity(id), liquidityTokenBal + LOCKED_LIQUIDITY);
            assertEq(hasAccruedFee, false);
        }
    }

    function test_FullRange_addLiquidity_SubsequentAdd() public {
    ...
    function test_FullRange_addLiquidity_SwapThenAddSucceeds() public {
        manager.initialize(key, SQRT_PRICE_1_1, ZERO_BYTES);
    ...
    function test_FullRange_addLiquidity_FailsIfTooMuchSlippage() public {
        manager.initialize(key, SQRT_PRICE_1_1, ZERO_BYTES);
    ...
    function test_FullRange_swap_TwoSwaps() public {
        PoolKey memory testKey = key;
        manager.initialize(testKey, SQRT_PRICE_1_1, ZERO_BYTES);
    ...
    function test_FullRange_swap_TwoPools() public {
        manager.initialize(key, SQRT_PRICE_1_1, ZERO_BYTES);
    ...
    function test_FullRange_removeLiquidity_InitialRemoveSucceeds() public {
    ...
    function test_FullRange_removeLiquidity_InitialRemoveFuzz(uint256 amount) public {
        manager.initialize(key, SQRT_PRICE_1_1, ZERO_BYTES);
    ...
    function test_FullRange_removeLiquidity_FailsIfNoPool() public {
    ...
    function test_FullRange_removeLiquidity_FailsIfNoLiquidity() public {
        manager.initialize(key, SQRT_PRICE_1_1, ZERO_BYTES);
    ...
    function test_FullRange_removeLiquidity_SucceedsWithPartial() public {
        manager.initialize(key, SQRT_PRICE_1_1, ZERO_BYTES);
    ...
    function test_FullRange_removeLiquidity_DiffRatios() public {
        manager.initialize(key, SQRT_PRICE_1_1, ZERO_BYTES);
    ...
    function test_FullRange_removeLiquidity_SwapAndRebalance() public {
        (, address liquidityToken) = fullRange.poolInfo(idWithLiq);
    ...
    function test_FullRange_removeLiquidity_RemoveAllFuzz(uint256 amount) public {
        manager.initialize(key, SQRT_PRICE_1_1, ZERO_BYTES);
        (, address liquidityToken) = fullRange.poolInfo(id);
    ...
    function test_FullRange_removeLiquidity_ThreeLPsRemove_PrincipalAndFees() public {
        ...
        // PoolManager does not have liquidity left over
    ...
    function test_FullRange_removeLiquidity_SwapRemoveAllFuzz(uint256 amount) public {
        manager.initialize(key, SQRT_PRICE_1_1, ZERO_BYTES);
        (, address liquidityToken) = fullRange.poolInfo(id);
